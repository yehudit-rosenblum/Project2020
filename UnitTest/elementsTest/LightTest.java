...
public class LightTest {
    ...
    public void spherePoint() {
        ...
        scene.addLights(new PointLight(new Color(500, 300, 0),
    ...
    public void trianglesDirectional() {
        ...
        scene.addLights(new DirectionalLight(new Color(300, 150, 150),
                new Vector(0, 0, 1)));
    ...
    /**Produce a picture of a sphere lighted by a Directional,point and spot light*/
    @Test
    ...
    public void triangAllLights() {
        ...
        scene.addLights(new DirectionalLight(new Color(200, 150, 150), new Vector(0, 0, 1)),
                new PointLight(new Color(200, 200, 200),
                        new Point3D(100, 100, 100), 1, 0.01, 0.01),
                new SpotLight(new Color(250, 250, 250), new Point3D(100, 100, 100), new Vector(-2, 2, 1), 1, 0.01, 0.01));


        ImageWriter imageWriter = new ImageWriter("triangAllLights", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);

...
public class ReflectionRefractionTests {
    ...
    public void trianglesTransparentSphere() {
        ...
        scene.addGeometries( //
                ...
                new Triangle(Color.BLACK, new Material(0.5, 0.5, 60), //
                        new Point3D(0, 0, 1500), new Point3D(5, 5, 1500), new Point3D(-5, 5, 1500)), //
    ...
    public void myTest() {
        ...
        scene.addGeometries( //
                new Triangle(new Color(100, 20, 20),new Material(0, 0, 0, 0, 1),
                        new Point3D(70, 70, 1500),
                        new Point3D(0, 0, 1500),
                        new Point3D(67, -67, 150)),
                new Triangle(new Color(20, 20, 20),new Material(0, 0, 0, 0, 0.5),
                        new Point3D(100, 100, 1500),
                        new Point3D(-100, 50, 1500),
                        new Point3D(-20, 20, 1500)),
                new Sphere(new Color(1, 1, 150), new Material(0.25, 0.25, 20, 0.5, 0), 40,
                        new Point3D(150, 0, 1500)),
                new Sphere(new Color(150, 20, 20), new Material(0.25, 0.25, 20), 20,
                        new Point3D(-20, 30, 1500)),
                new Polygon(new Color(java.awt.Color.GREEN),
                        new Material(0.2, 0.2, 30, 1, 0)
                        ,new Point3D(0,4 , 1500),
                        new Point3D(-20, 6, 1500),
                        new Point3D(-40, 4, 1500),
                        new Point3D(-35,1, 1500),
                        new Point3D(-5,1, 1500)));
        ...
        ImageWriter imageWriter = new ImageWriter("My test", 200, 200, 600, 600);
        Render render = new Render(imageWriter, scene);

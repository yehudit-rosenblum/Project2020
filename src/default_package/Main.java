...
public final class Main {
    ...
    public static void main(String[] args) {
        ...
        if (!isZero(new Vector(0.0, 3.0, 4.).length() - 5))
        ...
        if (!Point3D.ZERO.equals(p1.add(new Vector(-1.0, -2.0,-3.0))))
            out.println("ERROR: Point + Vector does not work correctly");
        if (!new Vector(1.0, 1.0, 1.0).equals(new Point3D(2.0, 3.0, 4.).subtract(p1)))

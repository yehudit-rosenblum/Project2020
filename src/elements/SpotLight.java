...
/**This Spotlight inherits from pointLight. (the position point and (mekadmey hanchata)
 * He also has a decay(deicha) with distance.
...
public class SpotLight extends PointLight {
     ...
     * @param p point
     * @return the intensity (which is a color based on hes distance and angle.*/
    @Override
